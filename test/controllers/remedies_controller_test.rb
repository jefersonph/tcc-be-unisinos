...
class RemediesControllerTest < ActionController::TestCase
  ...
  test "should create remedy" do
    assert_difference('Remedy.count') do
      post :create, remedy: { name: @remedy.name, quantidade: @remedy.quantidade, user_id: @remedy.user_id }
    end
  ...
  test "should update remedy" do
    patch :update, id: @remedy, remedy: { name: @remedy.name, quantidade: @remedy.quantidade, user_id: @remedy.user_id }
    assert_redirected_to remedy_path(assigns(:remedy))
  end
